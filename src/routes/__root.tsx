...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Thiago Abrantes" },
      { property: "og:title", content: "Thiago Abrantes | Corretor de Imóveis — CRECI 5760-f" },
      { property: "og:description", content: "Orientação para comprar seu imóvel e entender o Minha Casa Minha Vida. Fale com Thiago Abrantes pelo WhatsApp." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@600;700&family=Manrope:wght@400;500;600;700&display=swap" },
    ],
  }),
